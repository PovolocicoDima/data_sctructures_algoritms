...
function pureRecursionOddValues(arr) {
  ...
  /*
    ...
    Данный способ использует рекурсию ровно тогда, когда аккумуляторная переменная
    ...
    конкатенирует числа, которые соответствуют условию (arr[0] % 2 !== 0) и остальной массив (-1)(arr.slice(1)) первый элемент
  */
